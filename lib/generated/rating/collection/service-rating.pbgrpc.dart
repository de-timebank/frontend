...
import 'service-rating.pb.dart' as $0;
export 'service-rating.pb.dart';

class ServiceRatingClient extends $grpc.Client {
  static final _$create =
      $grpc.ClientMethod<$0.Create_Request, $0.Create_Response>(
          '/timebank.servicerating.ServiceRating/create',
  ...
  static final _$get = $grpc.ClientMethod<$0.Get_Request, $0.Get_Response>(
      '/timebank.servicerating.ServiceRating/get',
  ...
  static final _$update =
      $grpc.ClientMethod<$0.Update_Request, $0.Update_Response>(
          '/timebank.servicerating.ServiceRating/update',
  ...
  static final _$delete =
      $grpc.ClientMethod<$0.Delete_Request, $0.Delete_Response>(
          '/timebank.servicerating.ServiceRating/delete',
          ($0.Delete_Request value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $0.Delete_Response.fromBuffer(value));

  ServiceRatingClient($grpc.ClientChannel channel,
...
abstract class ServiceRatingServiceBase extends $grpc.Service {
  $core.String get $name => 'timebank.servicerating.ServiceRating';

  ServiceRatingServiceBase() {
