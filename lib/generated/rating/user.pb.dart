...
class GetRating_Request extends $pb.GeneratedMessage {
  ...
  factory GetRating_Request.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory GetRating_Request.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  GetRating_Request copyWith(void Function(GetRating_Request) updates) =>
      super.copyWith((message) => updates(message as GetRating_Request))
          as GetRating_Request; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static GetRating_Request create() => GetRating_Request._();
  GetRating_Request createEmptyInstance() => create();
  static $pb.PbList<GetRating_Request> createRepeated() =>
      $pb.PbList<GetRating_Request>();
  @$core.pragma('dart2js:noInline')
  static GetRating_Request getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<GetRating_Request>(create);
...
class GetRating_Response extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<$0.RatingData>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'ratings',
        $pb.PbFieldType.PM,
        subBuilder: $0.RatingData.create)
    ..hasRequiredFields = false;
  ...
  factory GetRating_Response.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory GetRating_Response.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  GetRating_Response copyWith(void Function(GetRating_Response) updates) =>
      super.copyWith((message) => updates(message as GetRating_Response))
          as GetRating_Response; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static GetRating_Response create() => GetRating_Response._();
  GetRating_Response createEmptyInstance() => create();
  static $pb.PbList<GetRating_Response> createRepeated() =>
      $pb.PbList<GetRating_Response>();
  @$core.pragma('dart2js:noInline')
  static GetRating_Response getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<GetRating_Response>(create);
  static GetRating_Response? _defaultInstance;

  @$pb.TagNumber(1)
  $core.int get average => $_getIZ(0);
  @$pb.TagNumber(1)
  set average($core.int v) {
    $_setSignedInt32(0, v);
  }
...
class GetRating extends $pb.GeneratedMessage {
  ...
  factory GetRating.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory GetRating.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  GetRating copyWith(void Function(GetRating) updates) =>
      super.copyWith((message) => updates(message as GetRating))
          as GetRating; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
